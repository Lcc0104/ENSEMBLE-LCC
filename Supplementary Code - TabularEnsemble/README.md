...
A full documentation is available at (the link is ANONYMOUS for now. The documentation is attached in `docs/build/html/index.html`). For a quick start:
...
See the documentation pages for details (the link is ANONYMOUS for now. The documentation is attached in `docs/build/html/index.html`).
